    ...
    return (
        <section className="text-center grid gap-6">
            ...
            <section className="grid gap-4 sm:grid-cols-[1fr_auto]">
                {/* secction arriba */}
                <article className="bg-white/70 p-2 py-6 rounded-3xl grid grid-cols-2 items-center">
                ...
                {/* seccion abajo */}
                <section className="bg-white/70 p-2 rounded-3xl grid grid-cols-3 justify-items-center items-center sm:grid-cols-1 sm:items-center">
                    ...
                    <article className="flex gap-2 sm:items-center" >
                        <div>
                            <img src="/images/humedity.png" alt="" />
                        </div>
                    ...
                    <article className="flex gap-2 sm:items-center" >
                        ...
                        <span>{weatherInfo?.main.pressure}m/s</span>
                    </article>
                </section>
            </section>
